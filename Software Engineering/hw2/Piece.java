...
public class Piece {
	...
	*/
	private static Piece makeFastRotations(Piece root) {
		root.next = findNextHelper(root, root);
		return root;
	}

	private static Piece findNextHelper(Piece root, Piece next) {
		Piece curr = next.computeNextRotation();
		if(curr.equals(root)){
			return root;
		}
		curr.next = findNextHelper(root, curr);
		return curr;
	}
